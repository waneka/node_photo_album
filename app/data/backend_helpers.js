...
exports.file_copy = function() {
  ...
  function copy(err) {
    ...
    if (!err && !can_overwite) {
      return callback(backhelp.error('file_exists', 'File ' + dst + ' exists.'))
    }
...
exports.album_already_exists = function() {
  return exports.error('album_already_exists', 'An album with this name already exists.')
}
